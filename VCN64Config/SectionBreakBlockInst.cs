...
{
    public class SectionBreakBlockInst : SectionTable
    {
        public SectionBreakBlockInst()
        {
            Table = new DataTable("BreakBlockInst");
            ...
            Table.Columns.Add("JmpPC", typeof(int));
        ...
        public void SetJmpPC(int index, int value)
        {
            DataRow row = GetRow(index);
            row[4] = value;
        }
